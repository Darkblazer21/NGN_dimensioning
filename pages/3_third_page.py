...
volume_trafic_total_phone_dl = 0.0
volume_trafic_total_card_dl = 0.0
volume_trafic_total_dl = 0.0
debit_internet_dl = 0.0
data_card_using_vpn_dl = 0.0
trafic_total_vpn_dl = 0.0
debit_total_vpn_dl = 0.0
